  ...
  <div class="flex">
    ...
    <main class="flex-1 p-6 ml-64 bg-gray-50 min-h-screen">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div class="bg-white shadow rounded p-4 flex flex-col">
          <span class="text-gray-500">Pending Invites</span>
          <span class="text-2xl font-bold">{{ stats.pendingInvites }}</span>
        </div>
      </div>
...
// Charts
const renderCharts = () => {
  const ctxShifts = document.getElementById('shiftsChart').getContext('2d')
  new Chart(ctxShifts, {
    type: 'bar',
    data: {
      labels: ['Week 1', 'Week 2', 'Week 3', 'Week 4'],
      datasets: [{ label: 'Shifts', data: [8, 10, 12, 15], backgroundColor: '#0B5351' }]
    },
  ...
  new Chart(ctxAttendance, {
    ...
    data: {
      ...
      datasets: [
        { label: 'Attendance', data: [8, 10, 9, 7, 12, 5, 0], borderColor: '#0B5351', fill: true, backgroundColor: 'rgba(11,83,81,0.2)' }
      ]
    },
