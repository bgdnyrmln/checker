    ...
    <main class="flex-1 pl-[22rem] min-h-screen relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-[120rem] mx-auto py-[4rem] px-[4rem]">
        ...
        <div class="mb-[4rem]">
          ...
          <h1 class="page-title text-[3.6rem] leading-none tracking-wide">Team Shifts</h1>
        </div>
        ...
        <!-- ── Create Shift ──────────────────────────────────────────── -->
        <div class="filter-card rounded-[1.6rem] p-[2.8rem] mb-[2rem]">
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-[1.6rem] mb-[2.4rem]">
          ...
          <div class="flex justify-end">
            <button
              @click="submitShift"
              class="calc-btn relative flex items-center gap-[0.8rem] px-[2.4rem] py-[1.1rem] rounded-[0.8rem] text-[1.3rem] text-white tracking-[0.06em] overflow-hidden hover:-translate-y-px active:translate-y-0 transition-all duration-200"
            >
        ...
        <div v-else-if="processedShifts.length" class="table-card rounded-[1.6rem] overflow-hidden">
          ...
          <div class="table-summary flex items-center justify-between px-[3rem] py-[2rem] flex-wrap gap-[1.6rem]">
            <div>
          ...
          <table class="w-full">
            <thead>
              <tr class="table-head-row">
                <th @click="sortBy('employee')" class="page-label px-[3rem] py-[1.6rem] text-left text-[1rem] tracking-[0.18em] uppercase font-normal cursor-pointer select-none">
                  <span class="flex items-center gap-[0.5rem]">Employee
                    <svg class="w-[1rem] h-[1rem] transition-transform" :style="{ opacity: sortKey==='employee' ? 1 : 0.3, transform: sortKey==='employee' && sortDirection==='desc' ? 'rotate(180deg)' : 'none' }" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5"/></svg>
                  </span>
                </th>
                <th @click="sortBy('email')" class="page-label px-[3rem] py-[1.6rem] text-left text-[1rem] tracking-[0.18em] uppercase font-normal cursor-pointer select-none">
                  <span class="flex items-center gap-[0.5rem]">Email
                    <svg class="w-[1rem] h-[1rem] transition-transform" :style="{ opacity: sortKey==='email' ? 1 : 0.3, transform: sortKey==='email' && sortDirection==='desc' ? 'rotate(180deg)' : 'none' }" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5"/></svg>
                  </span>
                </th>
                <th @click="sortBy('date')" class="page-label px-[3rem] py-[1.6rem] text-left text-[1rem] tracking-[0.18em] uppercase font-normal cursor-pointer select-none">
                  <span class="flex items-center gap-[0.5rem]">Date
                    <svg class="w-[1rem] h-[1rem] transition-transform" :style="{ opacity: sortKey==='date' ? 1 : 0.3, transform: sortKey==='date' && sortDirection==='desc' ? 'rotate(180deg)' : 'none' }" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5"/></svg>
                  </span>
                </th>
                <th @click="sortBy('start')" class="page-label px-[3rem] py-[1.6rem] text-left text-[1rem] tracking-[0.18em] uppercase font-normal cursor-pointer select-none">
                  <span class="flex items-center gap-[0.5rem]">Start
                    <svg class="w-[1rem] h-[1rem] transition-transform" :style="{ opacity: sortKey==='start' ? 1 : 0.3, transform: sortKey==='start' && sortDirection==='desc' ? 'rotate(180deg)' : 'none' }" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5"/></svg>
                  </span>
                </th>
                <th @click="sortBy('end')" class="page-label px-[3rem] py-[1.6rem] text-left text-[1rem] tracking-[0.18em] uppercase font-normal cursor-pointer select-none">
                  <span class="flex items-center gap-[0.5rem]">End
                    <svg class="w-[1rem] h-[1rem] transition-transform" :style="{ opacity: sortKey==='end' ? 1 : 0.3, transform: sortKey==='end' && sortDirection==='desc' ? 'rotate(180deg)' : 'none' }" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5"/></svg>
                  </span>
                </th>
            ...
            <tbody>
              <tr
                v-for="(shift, i) in processedShifts"
                :key="shift.id"
                class="table-row"
