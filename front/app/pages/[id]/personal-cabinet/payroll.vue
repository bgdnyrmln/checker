    ...
    <main class="flex-1 pl-[22rem] min-h-screen relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-[96rem] mx-auto py-[4rem] px-[4rem]">
        ...
        <div class="mb-[4rem]">
          ...
          <h1 class="page-title text-[3.6rem] leading-none tracking-wide">My Payroll</h1>
        </div>
        ...
        <div v-else-if="payroll">
          ...
          <!-- Summary stat cards -->
          <div class="grid grid-cols-1 md:grid-cols-3 gap-[2rem] mb-[2.4rem]">

            <div class="stat-card rounded-[1.6rem] p-[2.8rem] flex flex-col justify-between">
            ...
            <div class="stat-card stat-card-accent rounded-[1.6rem] p-[2.8rem] flex flex-col justify-between">
              <div class="flex items-start justify-between mb-[2rem]">
