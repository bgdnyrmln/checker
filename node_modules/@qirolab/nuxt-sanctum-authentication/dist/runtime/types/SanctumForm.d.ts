...
export interface SanctumForm<Data extends Record<string, unknown>> {
     ...
     */
    submit<T = any, R extends ResponseType = 'json'>(options?: FetchOptions<ResponseType>): Promise<MappedResponseType<R, T>>;
    /**
     ...
     */
    setErrors(errors: Partial<Record<keyof Data, string | string[]>>): Data & SanctumForm<Data>;
    /**
